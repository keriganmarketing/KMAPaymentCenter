            ...
            <div class="content">
                ...
                if( (isset($_POST['kmapc_submit_service']) && $_POST['kmapc_submit_service'] == 'yes') ){
                    echo '<article class="message"><div class="message-body">
                        <button class="delete is-pulled-right" aria-label="delete"></button>' . $paymentServices->handleSubmit($_GET,$_POST) . '</div>
                    </article>';
                }
                ...
                <form name="kmapc_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
                    ...
                    <div class="editor-wrapper">
                        <h4 class="wp-heading-inline"><?php echo ($paymentServices->state == 'change' ? 'Editing ' . $kmapcServicesTitle : 'Add New Service'); ?></h4>
                        ...
                        <div class="control">
                            <label class="radio">
                                <input type="radio" class="toggle-recurring" value="1" name="kmapc_services_recurring" <?php echo $kmapcServicesRecurring == 1 ? 'checked' : ''; ?>> Yes
                            </label>
                            <label class="radio">
                                <input type="radio" class="toggle-recurring" value="0" name="kmapc_services_recurring" <?php echo $kmapcServicesRecurring == 0 ? 'checked' : ''; ?>> No
                            </label>
                        </div>
                        <br>

                        <div id="recurringDiv" style="<?php echo $kmapcServicesRecurring == 0 ? 'display:none' : 'block'; ?>">
                            ...
                            <div class="column is-4">
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        <p><strong class="is-size-4">$<?php echo number_format($service->kmapc_services_price); ?></strong> <?php
                                    ...
                                    <div class="card-footer">
                                        <a class="card-footer-item is-primary" href="?page=payment-services&change=1&id=<?php echo $service->kmapc_services_id; ?>" >Change</a>
                                        <a class="card-footer-item is-danger" href="?page=payment-services&delete=1&id=<?php echo $service->kmapc_services_id; ?>" >Delete</a>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
